...
const rule = require('../../../lib/rules/camelcase-deprecation-support');
...
module.exports = ruleTester =>
  ruleTester.run('camelcase-deprecation-support', rule, {
    valid: [
      'UNSAFE_componentDidMount = () => null;',
      'firstName = "Nicholas"',
      'FIRST_NAME = "Nicholas"',
    ...
    invalid: [
      {
        code: 'UNSAFE_component_will_mount = () => null;',
        errors: [
          {
            messageId: 'notCamelCase',
            data: {name: 'UNSAFE_component_will_mount'},
            type: 'Identifier',
          },
        ],
      },
